namespace PhotographyToolkit.UI.WUP
{
    using System.Collections.Generic;
    using System.Linq;

    using PhotographyToolkit.UI.WUP.Controls;
    using PhotographyToolkit.UI.WUP.Views;
        ...
        private List<NavMenuItem> navlist = new List<NavMenuItem>(
            new[]
            {
                new NavMenuItem()
                {
                    ...
                    Label = "Exposure",
                    DestPage = typeof(ExposureCalculatorView)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.Refresh,
                    Label = "Shutter Speed",
                    DestPage = typeof(MinimalShutterSpeedView)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.World,
                    Label = "Sunset/Sunrise",
                    DestPage = typeof(SunsetSunriseView)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.Video,
